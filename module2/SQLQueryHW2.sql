...
FROM [sectors]
WHERE sector_name = 'value 1' or sector_name = 'value 3' or sector_name = 'value 4' or sector_name = 'value 5'
AND NOT sector_name = 'value 2' or sector_name = 'value 7'
...
SELECT COUNT(Customer_Id) AS nr_customers, pack_id
FROM [customers]
GROUP BY pack_id
HAVING pack_id IS NOT NULL
